<?php
require_once __DIR__ . '/../../controlador/profesor/ProfesorController.php';
?>
...
$profesores = $controller->leerTodos();
?>
        ...
        <div class="col col-12">
            <div class="card shadow-sm mb-4">
                <div class="card-header bg-primary text-white">
                    <h3 class="mb-0">Crear Profesor</h3>
                </div>
                <div class="card-body">
...
<div class="container mt-4">
    <div class="row">
                            ...
                            <tr>
                                ...
                                <td class="actions">
                                    ...
                                    <form method="post" action="" class="d-inline ms-2">
                                        <input type="hidden" name="id" value="<?= $row['id'] ?>">
                                        <button type="submit" name="eliminar" class="btn btn-danger btn-sm" onclick="return confirm('¿Está seguro de eliminar este profesor?');">
        ...
        <h2 class="h4 mb-3">Lista de Profesores</h2>
    ...
    <?php while ($row = $profesores->fetch_assoc()) : ?>
        <tr>
            ...
            <td class="actions">
                ...
                <form method="post" action="" class="d-inline ms-2">
                    <input type="hidden" name="id" value="<?= $row['id'] ?>">
                    <button type="submit" name="eliminar" class="btn btn-danger btn-sm" onclick="return confirm('¿Está seguro de eliminar este profesor?');">Eliminar</button>
                </form>
            </td>
        </tr>
    <?php endwhile; ?>
